"""
Generador de IDs únicos para figuras geométricas.
Implementa el patrón Singleton para garantizar IDs únicos globalmente.
"""

class GeneradorID:
    """
    Clase responsable de generar IDs únicos para figuras.
    Implementa el patrón Singleton para garantizar consistencia.
    """
    ...
    def establecer_contador(self, valor: int) -> None:
        """
        Establece el contador en un valor específico.
        Útil para sincronizar con IDs existentes.
    ...
    def establecer_siguiente_id(self, valor: int) -> None:
        """
        Establece el próximo ID que se asignará.
        
        Args:
            valor (int): Próximo ID a asignar
        """
        if valor <= 0:
            raise ValueError("El próximo ID debe ser mayor que 0")
    ...
    def actualizar_si_mayor(self, id_existente: int) -> None:
        ...
        Útil al cargar figuras desde archivo.
