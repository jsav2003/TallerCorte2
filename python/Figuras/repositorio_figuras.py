"""
Módulo para el repositorio de figuras - manejo de almacenamiento y persistencia.
"""
import os
...
class RepositorioFiguras:
    """
    Repositorio para manejo de figuras geométricas en memoria y persistencia.
    """
    ...
    def __init__(self, archivo_persistencia: str = "figuras.json", auto_guardar: bool = True):
        ...
        Args:
            ...
            auto_guardar (bool): Si debe guardar automáticamente los cambios
        """
    ...
    def _auto_guardar_si_habilitado(self):
        """Guarda automáticamente si está habilitado el auto-guardado."""
        if self.auto_guardar:
            try:
                self.guardar_figuras()
            except Exception:
                # Si hay error en el auto-guardado, no interrumpir la operación
                pass
    ...
    def almacenar_figura(self, figura) -> int:
        ...
        self._auto_guardar_si_habilitado()  # Guardar automáticamente
        return figura_id
    ...
    def contar_figuras(self) -> int:
        """
        Cuenta el número de figuras almacenadas.
        
        Returns:
            int: Número de figuras
        """
    ...
    def guardar_en_archivo(self, nombre_archivo: str) -> bool:
        """
        Guarda las figuras en un archivo específico.
        ...
        try:
            ...
            return self.persistencia.guardar(ruta_completa, list(self.figuras.values()))
        except Exception:
            return False
    
    def cargar_desde_archivo(self, nombre_archivo: str) -> int:
        """
        Carga figuras desde un archivo específico.
        
        Args:
            nombre_archivo (str): Nombre del archivo
            
        Returns:
            int: Número de figuras cargadas
        """
        try:
            ...
            figuras_cargadas = self.persistencia.cargar(ruta_completa)
            if figuras_cargadas:
